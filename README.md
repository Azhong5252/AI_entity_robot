...
```
curl -L -o GPT-SoVITS-main\pretrained_models.zip https://github.com/Azhong5252/AI_entity_robot/releases/download/GPT-SoVITS_uvr5/UVR5.Weights.zip
...
tar -xf "GPT-SoVITS-main\UVR5.Weights.zip" -C "GPT-SoVITS-main\tools\uvr5\uvr5_weights"
